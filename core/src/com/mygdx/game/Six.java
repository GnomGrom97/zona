...
public class Six implements Screen {//фотка взрыва
    final Drop game;
    SpriteBatch batch;
    OrthographicCamera camera;
    TextureRegion backgroundTexture;

    public Six(final Drop gam) {
        game = gam;
        backgroundTexture = new TextureRegion(new Texture("house.jpg"), 0, 0, 800, 480);
    ...
    public void render(float delta) {
        ...
        game.font.draw(game.batch, "Please,touch 6 to go,6!", 100, 100);
        game.batch.end();
